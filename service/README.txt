...
I used Android NDK r7.

Just run: make

It depends on your phone's cpu, either of them should work. These script files are not for reading, but it should be easy to compile with these. Feel free to ask if you have any problems.
